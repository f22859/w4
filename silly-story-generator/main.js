...
const storyText = '外は華氏９４度だったので、:insertx:　は買い物に行きました。　彼らが :inserty: に到着した時、　ものすごい人の多さに目を見開きました。 次の瞬間、いきなり :insertx:　は　:insertz:。 Bob　はその様子を見て、大爆笑しました。:insertx: の体重は500ポンド　で、大嵐の日でした。';
